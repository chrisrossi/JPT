 ...
 */
public abstract class PageTemplateTest extends TestCase {
    public PageTemplateTest( String name ) {
        super(name);
    }

    public void testStatements() throws Exception {
        Map dictionary = new HashMap();
        dictionary.put( "person", "Rudolfo" );
        dictionary.put( "animal", "scoiattolo" );
        testPageTemplate( "statements", dictionary );
        testPageTemplate( "statements", dictionary );
    }
    ...
    public void testMacros() throws Exception {
        Map dictionary = new HashMap();
        dictionary.put( "tsongas", "dead" );
        dictionary.put( "algonquin", "books" );
        testPageTemplate( "macros", dictionary );
        testPageTemplate( "macros", dictionary );
    }
    ...
    private void testPageTemplate( String test, Map dictionary ) throws Exception {
        ...
        PageTemplate template = new PageTemplateImpl( getClass().getResource( jpt ) );
